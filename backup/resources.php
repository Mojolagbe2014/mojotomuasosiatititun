	      ...
	      <div class="row">
	        <div class="col-md-12">
	        	<div class="inner-title-content">
		        	<h2 style="font-size:18px;">Articles</h2>
		        	<ul class="breadcrumb">
			            <li>List of all our educative article</li>
		          	</ul>
	          	</div>
	        </div>
	      </div>
		...
		<div class="container">
			<div class="row">
					...
					<section class="blog-post">
						<div class="row">
							<div class="col-lg-12 col-md-12">
				              ...
				              <?php
							echo ShowArticles($offset,$recordperpage);
							?>
				            </div>
								</div>
								<!-- Author info start -->
								...
								<!-- Author info end -->
									...
									<!-- Pagination start -->
                                   <?php PagingNew('articles',"","article_id",$recordperpage,$pagenum,"resources?get")?>
					<!--<div class="paging">
			            <ul class="pagination">
				...
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					<!-- sidebar start -->
                    <?php include('tools/side-bar.php');?>
					<!-- sidebar end -->
				</div>
    		</div><!--/ row end -->
		</div><!--/ container end -->
