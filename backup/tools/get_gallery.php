								...
								<div class="thumbnail">
								    <div class="caption">
								    	<div class="caption-content">
									    	<span>
												<a data-rel="prettyPhoto" href="images/gallery/<?php echo $gallery['file'];?>">
								   ...
								   <img height="200" width="200" src="images/gallery/thumb/<?php echo $gallery['file'];?>" alt="<?php echo $gallery['gallery_id'];?>" />
								</div>
							</div>          
