...
<title>New Gallery Image | Admin</title>
...
<script type="text/javascript" src="js/jquery.min_2.js"></script>
		...
		var status = $('#status');
		var title = $('#title');
		var file = $('#galleryField');
		var type = $('#type');
		var btn = $('#button');
					   
		$('#gallery').bind('submit', function(e) {
...
.progressBar { position:relative; width:400px; border: 1px solid #ddd; padding: 1px; border-radius: 3px; margin-left:auto; margin-right:auto;}
                  ...
                  <li><a href="all-media"><span>All media uploads</span></a></li>
                      <li><a href="media"><span>New media upload</span></a></li>
                       <li><a href="all-gallery" ><span>Gallery Images</span></a></li>
                         <li><a href="#" class="current"><span>Gallery Upload</span></a></li>
...
<!-- CONTENT START -->
    ...
    <!--  TITLE START  --> 
    <div class="grid_9">
     <h1 class="content_edit">New Gallery Image</h1>
    </div>
    ...
    <div class="progressBar">
		...
		<form action="headers/gallery-upload.php" method="post" enctype="multipart/form-data" id="gallery" >
    	<label>Title:</label>
        <input name="title" type="text" class="smallInput wide" id="title" value="" />
<label>File:</label>
        <div id="file"><input name="galleryField" type="file" class="smallInput wide" id="galleryField" size="140" /></div>
        <!--Include the iframe-->
   <label>Image Category</label>
        <select name="type" class="smallInput wide" id="type">
          <option selected="selected" value="" >Select Category</option>
          
          <option value="training">Training Image</option>
           <option value="facility">Facility Image</option>
