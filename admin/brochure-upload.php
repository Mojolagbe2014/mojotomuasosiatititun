            ...
            <ul>
                      ...
                      <li><a href="media"><span>New media upload</span></a></li>
                       ...
                       <li><a href="all-gallery"><span>Gallery Images</span></a></li>
                         ...
                         <li><a href="#" class="current"><span>Brochure Upload</span></a></li>
...
<!-- CONTENT START -->
    ...
    <!--  TITLE START  --> 
    <div class="grid_9">
     <h1 class="content_edit">Upload Brochure</h1>
    </div>
    ...
    <div class="progressBar">
		...
		<form action="headers/uploadFile.php" method="post" enctype="multipart/form-data" id="brochure" >
    	<label>Title:</label>
        <input name="title" type="text" class="smallInput wide" id="title" value="" />
<label>PDF File:</label>
        <div id="file"><input name="pdf" type="file" class="smallInput wide" id="pdf" size="140" /></div>
        <!--Include the iframe-->
 <label>Excel File:</label>
        <div id="file"><input name="excel" type="file" class="smallInput wide" id="excel" size="140" /></div>
