...
if(isset($_GET['delete'])){
	MysqlQuery("delete from uploads where id='".$_GET['delete']."'");
...
<title>All Media Files | Admin</title>
...
<!-- TABS START -->
    <div id="tabs">
         <div class="container">
           <ul>
                       <li><a href="all-media" class="current"><span>All media uploads</span></a></li>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" id="box-table-a" summary="Employee Pay Sheet">
            <thead>
              <tr id="chkrow">
                ...
                <th width="276" scope="col">File Name</th>
                <th width="129" scope="col">Posted date</th>
                <th width="56" scope="col">Downloads</th>
			...
			?>
              <tr>
                ...
                <td align="center"><?php echo $rows['no_down'];?></td>
                <td width="123"><a href="edt-media?edit=true&id=<?php echo $rows['id'];?>" class="edit_icon" title="Edit"></a> <a href="javascript:DeleteArticle(<?php echo $rows['id'];?>)" class="delete_icon" title="Delete"></a></td>
              </tr>
              <?php
              }
			  ?>
			  <tr class="footer">
                ...
                <td colspan="5" align="right">
                  <!--  PAGINATION START  -->             
                  <?php Pages_admin("SELECT COUNT(id) AS numrows FROM uploads ",$recordperpage,$pagenum,"all-media?get"); ?>  
                  <!--  PAGINATION END  -->                </td>
                </tr>
                <?php
			}
				  ...
				  ?>
              <tr>
                <td colspan="6"><?php echo warningMsg("No Flie(s) found");?></td>
                </tr>
                <?php
			  }
			  ?>
