...
reset ($article);
	...
	if(MysqlQuery("insert into articles (article_title,article_content,posted_date,sort_date)
										  values('".$_SESSION['title']."','".$_SESSION['description']."','$date','$NewDate')")){
		reset ($article);
	while (list ($key, $val) = each ($article)) {
		if (isset($_SESSION[$key])) $_SESSION[$key] = "";
	}
	header("location: newarticle.php?status=success");
			}
...
if(isset($_GET['status'])){
	$message  = successMsg("Article was submitted successfully!");
}
?>
    ...
    <div id="tabs">
         <div class="container">
            <ul>
                      ...
                      <li><a href="newarticle.php" class="current"><span>New Article</span></a></li>
...
<!-- CONTENT START -->
    ...
    <!--  TITLE START  --> 
    <div class="grid_9">
     <h1 class="content_edit">New Article</h1>
    </div>
    ...
    <div class="portlet">
        ...
        <!-- BUTTONS -->
        <a class="button" href="javascript:void(0);" onclick="Send()"><span>Submit Article</span></a>
