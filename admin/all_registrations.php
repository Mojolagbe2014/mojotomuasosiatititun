...
$result = MysqlSelectQuery("select * from registration order by reg_id desc limit $offset, $recordperpage");
$result_num = MysqlSelectQuery("select * from registration");
...
<title>Course Registrations | Admin</title>
    ...
    <div id="tabs">
         <div class="container">
            <ul>
                      ...
                      <li><a href="all_registrations"  class="current"><span>Registrations</span></a></li>
...
<!-- CONTENT START -->
    ...
    <!--RIGHT TEXT/CALENDAR-->
    <div class="grid_6" id="eventbox"><a href="#" class="inline_calendar">You have a total of (<?php echo NUM_ROWS($result_num);?>) Candidates</a>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" id="box-table-a" >
            <thead>
              <tr id="chkrow">
                ...
                <th width="147" scope="col">Course</th>
			...
			if(NUM_ROWS($result) > 0){
				...
				$result_title = MysqlSelectQuery("select * from events where event_id='".$rows['event_id']."'");
			...
			?>
              <tr>
                ...
                <td><?php echo $title['event_title'];?></td>
                <td><?php echo $rows['telephone'];?></td>
                <td align="left"><a href="#" style="text-decoration:underline"></a><?php echo $rows['email'];?></td>
              ...
              <tr class="footer">
                ...
                <?php Pages_admin("SELECT COUNT(reg_id) AS numrows FROM registration ",$recordperpage,$pagenum,"all_registrations?&get"); ?>
                  <!--  PAGINATION START               
