				...
				<div class="row">
					<div class="col-md-3">
						<div class="footer-about-us">
                            ...
                            <strong>Socialize with us &nbsp; : &nbsp;</strong>
								<a href="http://twitter.com/tomassociatesng" target="_blank" title="twitter page" style="color:#00CCFF;"><i class="fa fa-twitter"></i></a>
								<a href="https://www.facebook.com/tomassociates" title="facebook page" style="color:#039;"><i class="fa fa-facebook"></i></a>
								<a href="https://plus.google.com/110541269371353134717/about" title="google+ page" style="color:#F00;"><i class="fa fa-google-plus"></i></a>
					...
					<div class="col-md-3">
						<div class="recent-post">
							...
							?>
	                            <li><a href="downloads" title="<?php echo $data['title'];?>"><?php echo $data['title'];?></a></li>
					...
					<div class="col-md-3">
						<div class="img-gallery">
							...
							?>
								<a class="thumb-holder" data-rel="prettyPhoto" href="images/gallery/<?php echo $facility['file'];?>" title="gallery image">
									<img src="images/gallery/thumb/<?php echo $facility['file'];?>" alt="gallery images">
								</a>
                                <?php
							}
							?>
				...
				<div class="row">
					<div class="col-md-5 wow fadeInLeft">
						<ul class="footer-bottom-menu">
	                        ...
	                        <li><a href="trainings" title="our courses">Courses</a></li>
					...
					<div class="col-md-2">
						<a id="back-to-top" href="#" class="scroll-up back-to-top" role="button" title="Click to return on the top page" data-toggle="tooltip" data-placement="left">
							<img class="wow flipInY" src="images/to-top.png" alt="back to top">
						</a>
					</div>
